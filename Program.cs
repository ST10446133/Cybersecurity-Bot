...
class CybersecurityChatbot
{
    static void Main()//main method
    {
        ...
        // Start playing the welcome audio in a separate thread
        Thread audioThread = new Thread(() => PlayAudio("welcome.wav"));
        audioThread.Start();
        ...
        Console.Clear();
        DisplayAsciiArt(); // Show ASCII art logo again after clearing the screen
    ...
    static void PlayAudio(string fileName)
    {
        try
        {
            string filePath = @"C:\Users\edith\source\repos\assignment1\assignment1\Welcome.wav"; // Path to your audio file
